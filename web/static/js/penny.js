...
var _user$project$Penny$decodeMode = A2(
	...
	function (mode) {
		...
		switch (_p1) {
			...
			case 'naught':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Penny$Naught);
			case 'tidy':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Penny$Tidy);
			case 'exercise':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Penny$Exercise);
			case 'fuel':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Penny$Fuel);
			case 'groom':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Penny$Groom);
			case 'inspire':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Penny$Inspire);
			case 'strategize':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Penny$Strategize);
			case 'create':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Penny$Create);
			case 'learn':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Penny$Learn);
			case 'work':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Penny$Work);
			case 'connect':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Penny$Connect);
			case 'consume':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Penny$Consume);
			case 'review':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Penny$Review);
			case 'automate':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Penny$Automate);
			case 'journal':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Penny$Journal);
			case 'read':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Penny$Read);
			case 'sleep':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Penny$Sleep);
			default:
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], mode, ' is not a valid mode'));
		}
	},
